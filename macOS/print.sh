...
title () {
  printf "\r\033[0;1;96m>\033[0;1m %s\033[0m\n" "$*"
}

warn () {
  printf "\r\033[0;1;35m!\033[0;1m %s\033[0m\n" "$*"
}
...
question () {
  printf "\r\033[0;1;33m?\033[0;1m %s\033[0m\n" "$*"
}

task () {
  printf "\r\033[0;94m…\033[0m %s" "$*"
}
...
success () {
  printf "\r\033[2K\033[0;32m\xE2\x9C\x94\033[0m %s\n" "$*"
}

fail () {
  printf "\r\033[2K\033[0;31mx\033[0m %s\n" "$*"
}
